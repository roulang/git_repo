   ...
   for(int i=st-1;i>=0;i--) {
      ...
      */
      ...
      if (i_expand==0) {         //not expand
         ...
         getNearestHighLowPrice3(lst_price,PERIOD_CURRENT,i,i_range,g_zigBuf,g_high_low,g_pivotBuf,g_pivot_sht,i_long,i_add_pivot,false,bar_status);
         ...
         if (g_larger_shift>0 && g_larger_shift==larger_shift) {     //
            ...
            getNearestHighLowPrice3(lst_price,larger_pd,g_larger_shift,i_range,g_zigBuf,g_high_low,g_pivotBuf,g_pivot_sht,i_long,i_add_pivot,true,bar_status);
         } else {
            ...
            getNearestHighLowPrice3(lst_price,larger_pd,g_larger_shift,i_range,g_zigBuf,g_high_low,g_pivotBuf,g_pivot_sht,i_long,i_add_pivot,false,bar_status);
